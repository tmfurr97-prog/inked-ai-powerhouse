...
export async function extractTextFromImage(input: z.infer<typeof ExtractTextFromImageInputSchema>): Promise<z.infer<typeof ExtractTextFromImageOutputSchema>> {
